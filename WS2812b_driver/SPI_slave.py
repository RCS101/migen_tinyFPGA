...
class SPI_slave(Module):
    ...
    #    self.miso = miso = platform.request("user_miso")
        ...
        self.data = data = Signal(24) # 27 bit LED register
        ...
        LED_WRITE:
            Once 24 bits have been recieved the data is shifted out to the LED.
        STOP:
            Dont know yet
        """
        ...
        ### LED_WRITE
        self.mosi_fsm.act("LED_WRITE",
            # Write to the LED
            # self.submodules.ws2812(self.data)
            NextState("STOP")
        )
        ### STOP
