...
_io = [
    ...
    ("user_sclk", 0, Pins("GPIO:1"), IOStandard("LVCMOS33")), # pin 2
#    ("user_miso", 0, Pins("GPIO:2"), IOStandard("LVCMOS33")), # pin
    ("user_mosi", 0, Pins("GPIO:3"), IOStandard("LVCMOS33")), # pin
    ("user_cs", 0, Pins("GPIO:4"), IOStandard("LVCMOS33")) # pin
]
